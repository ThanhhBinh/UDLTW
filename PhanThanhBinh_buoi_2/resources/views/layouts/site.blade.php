    ...
    <header class="header">
        <div class="grid">
          <nav class="header__navbar">
            <ul class="header__navbar-list">
              ...
              >
                ...
                <div class="header__qr">
                  <img
                    src="assets/images/qrcode-default.png"
                    alt="qr"
                  ...
                  <div class="header__qr-apps">
                    ...
                    <a href="" class="header__qr-link">
                      <img
                        src="assets/images/tải xuống (1).jpg"
                        alt="app store"
                        class="header__qr-dowload-img"
                      />
                    </a>
            ...
            <ul class="header__navbar-list">
              <li class="header__navbar-item header__navbar-icon--has-notify">
                    ...
                    <li class="header__notify-item header__notify-item--viewed">
                      <a href="" class="header__notify-link">
                        ...
                        <div class="header__notify-info">
                          ...
                          <span class="header__notify-descrip"
                            >Đây là sản phẩm chính hang
                          </span>
                        </div>
                      </a>
                    </li>
              ...
              <li class="header__navbar-item">
                <a href="" class="header__navbar-item-link"
                  ><i class="header__navbar-icon fas fa-question-circle"></i>Trợ
                  giúp</a
                >
              </li>
        ...
        >
          ...
          <div class="col-md-2">
            ...
            <ul class="footer-list">
              ...
              <li class="footer-item">
                <a href="#" class="footer-item__link">Điện tử</a>
              </li>
              <li class="footer-item">
          ...
          <div class="col-md-2">
            ...
            <div class="footer__dowload">
              ...
              <div class="footer__dowload-apps">
                <a href="#" class="footer__dowload-link">
                  <img
                    src="assets/images/ch-play-apk.png"
                    alt="ch-play-apk"
